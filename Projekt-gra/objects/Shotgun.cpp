    ...
    if(combat) {
        if (ammunition > 0) {
            if (ready) {
                ...
                ThrowableContainer::addItem(4,shotgun.getPosition().x + 15*n + 5,shotgun.getPosition().y,n);
                ThrowableContainer::addItem(4,shotgun.getPosition().x + 15*n + 10,shotgun.getPosition().y+10,n, -15, -15);
                ammunition -= 3;
                ready = false;
            } else {
